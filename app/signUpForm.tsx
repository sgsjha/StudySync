...
export function SignupFormDemo() {
  const [isLoginMode, setIsLoginMode] = useState(false); // State to toggle between Sign Up and Login
  ...
  return (
    <div className="max-w-md w-full mx-auto rounded-none md:rounded-2xl p-4 md:p-8 shadow-input bg-white dark:bg-black">
      ...
      <form className="my-8" onSubmit={handleSubmit}>
        ...
        <button
          className="bg-gradient-to-br relative group/btn from-gray-600 to-gray-900 block dark:bg-gray-800 w-full text-white rounded-md h-10 font-medium shadow-input dark:shadow-[0px_0px_1px_1px_var(--neutral-800)]"
          type="button"
